					...
					<ul class="app_list">
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                                ...
                                <input type="text" placeholder="작성자" name="email" value="${content.email }" required readonly/>
                            </div>
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" class="w100p" id="name_lbl" placeholder="제목을 입력하세요" name="title" value="${content.title }" required/></div>
						</li>
...
전화 상담 희망시 기재 부탁드립니다." name="content">${content.content }</textarea></div>
						</li>
					</ul>
					<p class="btn_line">
						<!-- 
